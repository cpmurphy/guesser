export const loadModules = async (version) => {
  ...
  const [ChessRules, { COLOR, PIECE }, GameState, MoveLocalizer, EvaluationExplainer, Fen] = await Promise.all([
  ...
  return { ChessRules, COLOR, PIECE, GameState, MoveLocalizer, EvaluationExplainer, Fen };
}; 
