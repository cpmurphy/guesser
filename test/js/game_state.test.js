...
describe('GameState', () => {
  ...
  describe('constructor', () => {
    it('initializes with correct castling rights from FEN', () => {
      let gameState = new GameState('r1bqk2r/pppp1pp1/2n2n1p/2b1p3/2B1P3/2P2N1P/PP1P1PP1/RNBQK2R w KQkq - 0 6');
    ...
    it('handles FEN with partial castling rights', () => {
      let gameState = new GameState('1nbqkbnr/1ppp1ppp/r7/p3p3/P3P3/R7/1PPP1PPP/1NBQKBNR w Kk - 2 4');
  ...
  describe('castling rights', () => {
    ...
    it('removes white queenside castling when a1 rook moves', () => {
      let gameState = new GameState('r1bqkbnr/2pp1ppp/p1n5/1p2p3/P3P3/1P6/1BPP1PPP/RN1QKBNR w KQkq - 0 5');
